...
export default function PartsPanel({
  ...
  return (
    <div
      className={`absolute top-4 right-4 bg-gray-900/95 backdrop-blur-sm rounded-lg shadow-xl border border-gray-700 w-54 z-40 transition-all duration-300 ease-in-out overflow-hidden ${
        expanded ? "max-h-[calc(100%-2rem)]" : "max-h-14"
      }`}
    >
