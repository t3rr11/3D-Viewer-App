      ...
      <div
        className={`absolute top-2 sm:top-4 right-2 sm:right-4 rounded-lg z-40 transition-all duration-300 ease-in-out overflow-hidden sm:bg-gray-900/95 sm:backdrop-blur-sm sm:shadow-xl ${
          isOpen || window.innerWidth >= 640
            ? expanded
              ? "max-h-[60vh] sm:max-h-[calc(100%-2rem)] border border-gray-700 bg-gray-900/95 backdrop-blur-sm shadow-xl"
              : "max-h-12 sm:max-h-14 border border-gray-700 bg-gray-900/95 backdrop-blur-sm shadow-xl"
            : "max-h-0 border-0 p-0 sm:max-h-[calc(100%-2rem)] sm:border sm:border-gray-700"
              ...
              {parts.map((part, index) => {
                ...
                return (
                  <div
                    ...
                    onClick={(e) =>
                      onPartClick?.(index, e.ctrlKey || e.metaKey)
                    }
                  >
                    <span
